...
const DragDropList = (props: {
  ...
  const onDragEnd: OnDragEndResponder = async (result) => {
    ...
    if (start === finish) {
      ...
      const newState = { ...props.data, columns: { ...props.data.columns, [newColumn.id]: newColumn } };
      ...
      const newState = { ...props.data, columns: { ...props.data.columns, [newStart.id]: newStart, [newFinish.id]: newFinish } };
      reorderTasks(taskDispatch, newState);
